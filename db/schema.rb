...
ActiveRecord::Schema.define(version: 20160626201949) do
  ...
  create_table "companies", force: :cascade do |t|
    ...
    t.integer  "max_marker",    limit: 4,   default: 1, null: false
    t.integer  "max_advertise", limit: 4,   default: 5, null: false
  end
