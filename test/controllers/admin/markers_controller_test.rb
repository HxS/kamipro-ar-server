...
class Admin::MarkersControllerTest < ActionController::TestCase
  setup do
    @marker = markers(:one)
  end
  ...
  test "should create marker" do
    assert_difference('Marker.count') do
      post :create, marker: { company_id: @marker.company_id, image_url: @marker.image_url }
    end
  ...
  test "should update marker" do
    patch :update, id: @marker, marker: { company_id: @marker.company_id, image_url: @marker.image_url }
    assert_redirected_to marker_path(assigns(:marker))
  end
